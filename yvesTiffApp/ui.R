...
ui <- fluidPage(
  ...
  mainPanel(widht=12,
    ...
    mainPanel(width=12,
    h6("Yves Gabriëls holds the copyright on the original images. The rds files and the images generated by this tool are not allowed to be used without permission of the copyright holder of the original images.")
    ))
